...
| # | Story | PRD story | Follows |
|---|---|---|---|
| 01 | [Snapshot carries authors, caps become reusable](01-snapshot-authors-and-caps.md) | none (prefactor) | none |
| 02 | [Shared PDS session with refresh](02-pds-session.md) | none (prefactor) | none |
| 03 | [Graph probe](03-graph-probe.md) | Limit the number of stored circles | 02 |
| 04 | [Probe gate](04-probe-gate.md) | Limit the number of stored circles | 03 |
| 05 | [Viewer identity behind the switch](05-viewer-identity.md) | Viewers without a valid login | none |
| 06 | ["I follow" circle end to end](06-i-follow-circle.md) | See only pairs from my circle; First open builds my circle; Scroll without repeats | 01, 04, 05 |
| 07 | ["Follows me" connections](07-follows-me.md) | See only pairs from my circle; First open builds my circle | 06 |
| 08 | [Degree 2 with a shared follows cache](08-degree-two.md) | Discover people one step out; First open builds my circle | 06 |
| 09 | [Circles stay current and bounded](09-circles-current-and-bounded.md) | My circle stays current; Limit the number of stored circles | 07, 08 |
| 10 | [Feed health metrics](10-feed-health-metrics.md) | Read feed health | 09 |
| 11 | [Launch](11-launch.md) | See only pairs from my circle; Viewers without a valid login | 04, 10 |
